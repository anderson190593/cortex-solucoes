          ...
          <div className="col-lg-6 hero-text-column">
            <div className="hero-content">
              ...
              <div className="d-flex gap-3 mt-4">
                <a href="#solucoes" className="btn btn-primary btn-lg">Conheça Nossas Soluções</a>
                <a href="https://marca-de-elite.vercel.app" className="btn btn-outline-light btn-lg">E-book Marca de Elite</a>
              </div>
            </div>
          </div>
